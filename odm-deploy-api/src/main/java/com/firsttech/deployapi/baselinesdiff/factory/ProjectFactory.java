...
public class ProjectFactory extends Factory {
    ...
    public void createProject(String name) throws IlrApplicationException {
        ...
        IlrRuleProject project = IlrSessionHelper.getProjectNamed(session, name);
        ...
        project = IlrSessionHelper.createRuleProject(session, name);
        ...
        IlrRuleProject loanvalidation = IlrSessionHelper.getProjectNamed(session, LOANVALIDATION_RULES);
