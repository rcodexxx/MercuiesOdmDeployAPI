...
public class Connection   {
	 ...
	 */
	public Connection(IlrRemoteSessionFactory factory, String user, String password, String url, String datasource) {
		super();
		this.user = user;
	...
	public Connection(String user, String password, String url, String datasource) {
		this(new IlrRemoteSessionFactory(), user,password, url, datasource);
	}
	...
	public String toString () {
		return " Url : " + url + " Datasource : " + datasource;
	}
}
